...
set output "ej2_nodos_completos.tex"
...
plot "ej2.backtracking.complete.out.sorted_by_nodes.average" using 1:($5*1000000000) title "Grafos Completos" with linespoints,\
    f(x) title "Cota teórica lineal $\\mathcal O(n)$" with lines lt 5 lw 6
