...
\begin{description}
    ...
    \item[Grafos completos\label{backtracking:poda:grafo_completo}]
        De los datos de entrada de un grafo sabemos ya $n$
    ...
    \item[Frontera m\'inima\label{backtracking:poda:cota_front_min}]
        Al comenzar a construir las cliques de $G$, la idea pasa
