...
\graphicspath{%
    ...
    {img/ej2/}%
    {img/ej3/}%
    {img/ej3/constructiva_golosa/}%
    {img/ej3/busqueda_local/}%
    {img/ej3/tabu_search/}%
    {img/ej4/}%
}
...
%Para usar referencias por el nombre en las listings de "description"\makeatletter
...
\usepackage{tikz}
\usetikzlibrary{arrows,chains,shapes,matrix,trees,positioning,petri,topaths,calc,decorations.pathreplacing}
...
%Paquetes para dibujar el arbol de decisiones
\usepackage{fancybox}
\usepackage{rotating}
\newcommand\dotstheta{\overset{\vdots}{\mathcal O(n)}}
\usepackage{rotfloat}
...
\newcommand{\Compl}[4]{%Para marcar las complejidades en los pseudos
    \Comment{\textcolor{#1}{\textbf{#2}$\mathcal O($#3$)$\ #4}}
}
...
\begin{document}
    ...
    \phantomsection
    \addcontentsline{toc}{section}{Notas Preliminares}
